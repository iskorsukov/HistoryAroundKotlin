package my.projects.historyaroundkotlin.presentation.view.permission.content
...
class PermissionsFragmentTest: BaseViewModelFragmentTest<PermissionFragment, PermissionViewModel>() {
    ...
    private fun pushPermissionNotGrantedViewState() {
        viewStateLiveData.postValue(
            PermissionViewState(
                ...
                listOf(PermissionRationaleUtils.LOCATION_RATIONALE)
            )
        )
    }
    ...
    fun navigatesToMainFlowAfterAllPermissionsGranted() {
        ...
        scenario.onFragment {
            it.onRequestPermissionsResult(PermissionViewModel.PERMISSIONS_REQUEST_CODE, emptyArray(), intArrayOf())
        }
    ...
    fun rechecksPermissionsAfterPermissionsInteraction() {
        ...
        scenario.onFragment {
            it.onRequestPermissionsResult(PermissionViewModel.PERMISSIONS_REQUEST_CODE, arrayOf(Manifest.permission.ACCESS_FINE_LOCATION), intArrayOf(PackageManager.PERMISSION_GRANTED))
        }
